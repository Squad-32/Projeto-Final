...
public class campanhasController {
    ...
    public String atualizarCampanha(@PathVariable Long id_campanha, Campanhas campanha) {
        campanha.setId_campanha(id_campanha); // Updated to use the correct setter method
        campanhasRepository.save(campanha);
        return "redirect:/campanhas";
    }
