    ...
    <section class="py-5 custom-section">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <p class="mb-4">
              Na Ecoartesia, acreditamos que a transformação positiva começa com a conscientização, a capacitação e a colaboração. Nossa organização
              se dedica a promover um mundo onde a diversidade seja não apenas respeitada, mas celebrada, e onde a sustentabilidade ambiental seja uma
            ...
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  ...
                  palestras informativas, buscamos sensibilizar as pessoas sobre os preconceitos arraigados e as discriminações existentes. Ao
                  promover a conscientização desde cedo, estamos moldando mentalidades e promovendo uma cultura de respeito à diversidade, que é
            ...
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  ...
                  empreendedores sustentáveis. Isso não apenas cria oportunidades de autoemprego, mas também promove uma mentalidade de negócios
                  voltados para a preservação ambiental, contribuindo para um crescimento econômico mais saudável e sustentável.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  ...
                  econômicas locais, como a produção de alimentos ecológicos ou produtos artesanais sustentáveis. Isso fortalece a economia local,
                  cria empregos e contribui para o desenvolvimento da comunidade.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  ...
                  interconexão entre preconceito, discriminação e degradação ambiental. Buscamos mobilizar um movimento social que exija ações
                  concretas para criar um futuro mais justo e sustentável.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  ...
                  vozes, capacitando essas comunidades para que desempenhem um papel ativo na construção de um futuro mais sustentável. O
                  empoderamento não apenas promove a inclusão, mas também capacita essas comunidades a serem líderes em iniciativas de preservação
                  ambiental.
                </p>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  Reconhecemos que a mudança efetiva requer esforços colaborativos. Estamos estabelecendo parcerias com organizações afins,
                  compartilhando recursos e conhecimento para amplificar nosso impacto. Juntos, podemos promover a diversidade, combater o preconceito
                  e trabalhar em prol de um ambiente mais equitativo e saudável.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  Ao capacitar as minorias para criar produtos ecológicos e cultivar alimentos, incentivamos a inovação e o desenvolvimento de
                  soluções criativas para os desafios ambientais. Essa mentalidade inovadora não apenas beneficia o meio ambiente, mas também pode
                  levar ao desenvolvimento de novos produtos e negócios, impulsionando o crescimento econômico.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card mb-4 fixed-height bg-image">
              ...
              <div class="card-body">
                <p class="card-text truncate">
                  A conscientização sobre limpeza urbana e diversidade é crucial para reduzir as diferenças no impacto da crise climática nas
                  comunidades BIPOC e LGBTQIA+. Ao nos concentrarmos na limpeza de áreas mais afetadas e trabalharmos para diminuir essas diferenças,
                  garantimos igualdade de oportunidades e recursos para enfrentar os desafios da mudança climática. Isso é fundamental para construir
